    ...
    <section className="relative bg-white">
      ...
      <div className="relative z-10 mx-auto max-w-2xl px-5 py-32 text-center leading-8 sm:px-8">
        <h2 className="text-3xl font-extrabold sm:text-5xl">
          <span className="text-slate-900">Discover the Future of</span>{' '}
        ...
        <div className="mt-8 items-center justify-center space-x-0 space-y-3 sm:flex sm:space-x-4 sm:space-y-0">
          <Link
            href="/#waitlist"
            className="block rounded-md bg-slate-800 px-8 py-3 text-sm font-medium text-white transition-colors hover:bg-slate-700"
          >
            Join Waitlist
          </Link>
          <Link
            href="/#about"
            className="block rounded-md border border-slate-200 bg-white px-8 py-3 text-sm font-medium text-slate-900 transition-colors hover:bg-slate-50"
          >
            Explore More
          </Link>
        </div>
